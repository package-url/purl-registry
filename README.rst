...
This problem extends beyond C and C++ packages to any package
...
and vulnerability management operations, including tracking these packages
unambiguously in SBOMs, VEXs, tools, and vulnerability databases.
